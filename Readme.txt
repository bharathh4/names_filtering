Motivation:
Not all names need lexicons. This is a process which determines what names are not popular and lumenvox will use a bad rule. This process helps us avoid adding a lexicon for popular names like john or smith. The interface needs will need some API aesthetics cleanup. Feel free to get offended for blatant disregard for discriminating gets and posts!
